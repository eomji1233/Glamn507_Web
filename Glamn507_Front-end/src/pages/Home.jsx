...
function Home() {
    ...
    useEffect(() => {
        fetch("https://glamn507.com/api/work/thumbnails")
            .then(res => res.json())
    ...
    useEffect(() => {
        fetch("https://glamn507.com/api/work/new")
            .then(res => res.json())
        ...
        <div>
            <div className="main-container">
                <div className="carousel-wrapper1">
                    <Slider {...settings1}>
                        <video
                            src="https://glamn507-portfolio-storage.s3.ap-northeast-2.amazonaws.com/videos/%EC%A0%9C%EB%AA%A9+%EC%97%86%EB%8A%94+%EB%94%94%EC%9E%90%EC%9D%B8.mp4"
                            autoPlay
                            muted
                            loop
                            playsInline
            ...
            <div className="slogan-container">
                <img src={require("../assets/img/13.jpg")} alt="bg" className="bg-image" />
                ...
                >
                    GLAMN 507 pushes boundaries with revolutionary technologies to craft content that didn’t exist until now.                </motion.p>
                    ...
                    <div className="slider-wrapper">
                        <Slider {...settings2}>
                            {thumbnails.map((thumb, index) => (
                                ...
                                >
                                    <img
                                        src={`https://glamn507-portfolio-storage.s3.ap-northeast-2.amazonaws.com/${thumb.thumbnailUrl}`}
                                        alt={`slide${index + 1}`}
            ...
            >
                ...
                <div className='works-frame'>
                    {newWorks.map((work, index) => (
                        ...
                        >
                            <img
                                src={`https://glamn507-portfolio-storage.s3.ap-northeast-2.amazonaws.com/${work.thumbnailUrl}`}
                                alt="slide1"
