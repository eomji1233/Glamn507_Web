            ...
            <div className="work-content">
                ...
                {work.video?.trim() && (
                    <div className="video-wrapper">
                        <video width="100%" controls autoPlay muted playsInline>
                            <source
                                src={`https://glamn507-portfolio-storage.s3.ap-northeast-2.amazonaws.com/${work.video}`}
                                type="video/mp4"
                            />
                        ...
                        <Slider {...settings}>
                            {images.map((img) => (
                                <div key={img} onClick={() => setPreviewImage(img)}>
                                    <img
                                        src={`https://glamn507-portfolio-storage.s3.ap-northeast-2.amazonaws.com/${img}`}
                                        alt="img"
                ...
                {previewImage && window.innerWidth > 768 && (
                    <div className="lightbox-overlay" onClick={() => setPreviewImage(null)}>
                        <img
                            src={`https://glamn507-portfolio-storage.s3.ap-northeast-2.amazonaws.com/${previewImage}`}
                            alt="Preview"
